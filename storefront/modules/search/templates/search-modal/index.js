...
import Hit from "@storefront/modules/search/components/hit"
import Hits from "@storefront/modules/search/components/hits"
import SearchBox from "@storefront/modules/search/components/search-box"
  ...
  return (
    <div className="relative z-[75]">
      ...
      <div className="fixed inset-0 px-5 sm:p-0" ref={searchRef}>
        <div
          className="flex flex-col justify-start w-full h-fit transform p-5 items-center text-left align-middle transition-all max-h-[75vh] bg-transparent shadow-none">
