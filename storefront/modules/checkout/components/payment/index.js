...
import PaymentContainer from "@storefront/modules/checkout/components/payment-container"
import { setPaymentMethod } from "@storefront/modules/checkout/actions"
    ...
    <div className="bg-white">
      ...
      <div>
        {cart?.payment_sessions?.length ? (
          ...
          <div
            className="flex flex-col items-center justify-center px-4 py-16 text-ui-fg-base">
            <Spinner />
          </div>
        )}
