        ...
        <div className="text-small-regular grid grid-cols-3 gap-x-10 md:gap-x-16">
                ...
                {product_categories?.slice(0, 6).map((c) => {
                  ...
                  return (
                    <li className="flex flex-col gap-2" key={c.id}>
                      <Link className={clsx(children && "text-small-semi")} href={`/${c.handle}`}>
                        {c.name}
                      </Link>
                      {children && (
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <ul className="grid grid-cols-1 gap-y-2">
              <li>
                <a href="https://github.com/medusajs" target="_blank" rel="noreferrer">
                  GitHub
                </a>
              </li>
              <li>
                <a href="https://docs.medusajs.com" target="_blank" rel="noreferrer">
                  Documentation
                </a>
              </li>
              <li>
