...
import { Button, Heading, Checkbox, Label } from "@medusajs/ui";
...
const AddAddress = ({ region }) => {
  ...
  const [formState, formAction] = useFormState(createCustomerAddress, {
    success: false,
    error: null,
  });
          ...
          <Modal.Body>
            <div className="flex flex-col gap-y-2 w-full pt-2">
              ...
              <div className="flex items-center space-x-2 mt-4">
                <Checkbox id="is_billing" name="is_billing" value="true" />
