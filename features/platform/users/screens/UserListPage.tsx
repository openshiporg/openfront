/**
 * UserListPage - Server Component
 * Uses dedicated Users actions for consistent data fetching
 */
...
import { getFilteredUsers, getUserStatusCounts } from '../actions'

interface PageProps {
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

export async function UserListPage({ searchParams }: PageProps) {
  ...
  // Hardcode the list key for users
  const listKeyPath = 'users';
