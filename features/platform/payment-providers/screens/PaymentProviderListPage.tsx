...
import { getPaymentProviders, getPaymentProviderRegionCounts } from '../actions'
...
export async function PaymentProviderListPage({ searchParams }: PageProps) {
  ...
  // Use PaymentProviders actions with where clause
  ...
  const regionCountsResponse = await getPaymentProviderRegionCounts()
