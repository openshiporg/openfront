...
export const ShippingProvider = list({
  ...
  fields: {
    ...
    createLabelFunction: text({
      validation: { isRequired: true },
      ui: {
        description: "Either an adapter name (e.g. 'easypost') or an HTTP endpoint that will be called with the order data",
      }
    }),
    ...
    validateAddressFunction: text({
      validation: { isRequired: true },
      ui: {
        description: "Either an adapter name (e.g. 'easypost') or an HTTP endpoint that will be called with the address data",
      }
    }),
    ...
    trackShipmentFunction: text({
      validation: { isRequired: true },
      ui: {
        description: "Either an adapter name (e.g. 'easypost') or an HTTP endpoint that will be called with the tracking number",
      }
    }),
    ...
    cancelLabelFunction: text({
      validation: { isRequired: true },
      ui: {
        description: "Either an adapter name (e.g. 'easypost') or an HTTP endpoint that will be called with the label ID",
      }
    }),
