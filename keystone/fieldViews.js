...
import * as view1 from "@keystone/views/Virtual";
import * as view2 from "@keystone/views/Text";
import * as view3 from "@keystone/views/Checkbox";
import * as view4 from "@keystone/views/JSON";
import * as view5 from "@keystone/views/Relationship";
