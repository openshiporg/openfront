...
export function ListTable({
  ...
  const columns = useMemo(() => {
    ...
    return [
      ...
      ...fieldsArray.map((fieldKey, i) => {
        const field = listTableData.fields[fieldKey];
              ...
              <Cell
                ...
                linkTo={
                  i === 0 && Cell.supportsLinkTo
                    ? {
                        href: `/${listTableData.path}/${encodeURIComponent(itemId)}`,
                      }
                    : undefined
                }
              />
  ...
  }, [selectedItems, selectedFields, listTableData.fields, orderableFields]);
