...
import { H1, Stack, Inline, VisuallyHidden } from "@keystone-ui/core"
...
function Welcome({ value, onContinue }) {
  ...
  return (
    <Stack gap="large">
      ...
      <p css={{ margin: 0 }}>
        Thanks for installing KeystoneJS. While you're getting started, check
        out the docs at <a href="https://keystonejs.com">keystonejs.com</a>
      </p>
      <div>
        If you'd like to stay up to date with the exciting things we have
        planned, join our mailing list (just useful announcements, no spam!)
      </div>
      <div>
        <Checkbox
          checked={subscribe}
...
function InitPage({ fieldPaths, listKey, enableWelcome }) {
...
export const getInitPage = props => () => <InitPage {...props} />
