...
import {
  Pagination,
  PaginationLabel
} from "../../../../admin-ui/components/Pagination"
...
const ResultsSummaryContainer = ({ children }) => (
  <p
    css={{
      // TODO: don't do this
...
const SortDirectionArrow = ({ direction }) => {
  const size = "0.25em"
  return (
    <span
      css={{
...
function DeleteManyButton({ selectedItems, list, refetch }) {
