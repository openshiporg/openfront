    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left">
        ...
        >
          ...
          <span className="text-emerald-700 text-sm font-bold rounded tracking-wide">
            COMING SOON
          </span>
        </Link>
        ...
        >
          ...
          <span className="text-blue-700 text-sm font-bold rounded tracking-wide">
            READY
          </span>
        </Link>
        ...
        >
          ...
          <span className="text-fuchsia-500 text-sm font-bold rounded tracking-wide">
            READY
          </span>
        </Link>
      </div>
