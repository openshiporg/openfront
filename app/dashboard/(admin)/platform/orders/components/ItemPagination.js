...
export function ItemPagination({
  ...
  const colorClasses = "bg-white border-blue-200 text-blue-500 hover:bg-blue-100 hover:text-blue-700 focus:ring-blue-700 dark:bg-blue-950 dark:border-blue-900 dark:text-blue-300 dark:hover:text-white dark:hover:bg-blue-700 dark:focus:ring-blue-500";
  ...
  return (
    <div className="h-7 shadow-sm flex items-center border rounded-sm overflow-hidden">
      ...
      <div className="bg-background text-nowrap flex items-center border-r-0 px-1 text-sm h-full">
        <input
          className="mx-1 bg-transparent border-0 focus:ring-0 text-center appearance-none text-blue-600 dark:text-blue-100"
          style={{
            width: `${Math.max(
              0.5,
